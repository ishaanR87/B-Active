...
public class CalorieTarget extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.calorietarget);

        /* Listener submit */
        Button buttonSubmit = (Button)findViewById(R.id.finishProfile);
    ...
    public void signUpGoalSubmit(){
        ...
        if(errorMessage.isEmpty()){
            Intent i = new Intent(CalorieTarget.this, Home.class);
            startActivity(i);
        }
    } // signUpGoalSubmit
